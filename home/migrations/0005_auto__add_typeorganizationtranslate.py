...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TypeOrganizationTranslate'
        db.create_table(u'home_typeorganizationtranslate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Language'])),
            ('typeorganization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.TypeOrganization'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'home', ['TypeOrganizationTranslate'])


    def backwards(self, orm):
        # Deleting model 'TypeOrganizationTranslate'
        db.delete_table(u'home_typeorganizationtranslate')
