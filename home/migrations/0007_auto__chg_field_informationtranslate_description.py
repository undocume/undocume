...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InformationTranslate.description'
        db.alter_column(u'home_informationtranslate', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'InformationTranslate.description'
        db.alter_column(u'home_informationtranslate', 'description', self.gf('django.db.models.fields.CharField')(max_length=500))
